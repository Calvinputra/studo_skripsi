...
@section('content')
                    ...
                    <div class="">
                        <div>
                            ...
                            <p style="margin-top:24px;">
                                1. Soal yang dibuat minimal 5 butir
                                <br>
                                    ...
                                    <p class="button-text-category m-0">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-content">
                                                <p>
                                                    Minimal pembuatan sebanyak 5 Pre-test dan 5 Post-test
                                                </p>
                                            </div>
                                        </div>
                                    </p>
                                ...
                                <div style="margin:40px 0px;">
                                    <div class="p-0" style="">
                                        <div class="d-flex align-items-center" style="height:39px;">
                                            <div class="d-flex align-items-center">
                                                <span class="google-text-login">Tambah Quest &nbsp;&nbsp;</span>
                                                <a href="#" style="" data-bs-toggle="modal" data-bs-target="#addQuestModal">
                                                                    ...
                                                                    <table id="myTableQuest" class="table mb-0" style="background-color: rgba(32, 162, 235, 0.1)">
                                                                        <thead style="background-color: rgba(32, 162, 235, 0.1);border-radius: 5px;">
                                                                            <tr class="text-uppercase" style="color: white">
                                                                                    ...
                                                                                    <th scope="col" class="filter" data-filter="name">Pertanyaan</th>
                                                                                    <th scope="col" class="filter" data-filter="name">Priority</th>
                                                                        ...
                                                                        <tbody>
                                                                            @foreach ($all_quest as $quest)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div data-bs-toggle="modal" data-bs-target="#updateQuestModal" class="btn-group" role="group" aria-label="Button group">
                                                                                            <a id="updateQuesthref" data-id="{{ $quest->id }}" data-slug="{{ $class->slug }}" href="#" style="color: #20A2EB;">Edit</a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                        ...
                        @if($count_posttest >= 5 && $count_pretest >= 5 )
                            ...
                            <div style="float:right;" class="pt-3">
                                <a class="btn my-2 my-sm-0" href="{{ route('internal_tutor.class.project', $class->slug) }}"
                                    style="color:#063852; border-color:#063852;background:white;font-weight: bold">
                                    Selanjutnya
                                </a>
                            </div>
                        ...
                        {{-- Input --}}
                        <form id="questForm" action="{{ route('internal_tutor.class.storeQuest', $class->slug) }}"
                            method="POST">
                            @csrf
                            <!-- Modal -->
                            <div class="modal fade" id="addQuestModal" tabindex="-1"
                                aria-labelledby="addQuestModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <select class="form-select" id="addQuestType" name="quest_type">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="answer[]" placeholder="Answer 1">
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="answer[]" placeholder="Answer 2">
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="answer[]" placeholder="Answer 3">
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="answer[]" placeholder="Answer 4">
                                            </div>
                                            <div class="mb-3">
                                                <input type="number" class="form-control" name="is_correct" placeholder="Jawaban yang benar (1-4)" max="4">
                                            </div>
                                            <div class="mb-3">
                        ...
                        {{-- Edit --}}
                        <form id="questUpdateForm" 
                            method="POST">
                            @csrf
                            <!-- Modal -->
                            <div class="modal fade" id="updateQuestModal" tabindex="-1"
                                aria-labelledby="updateQuestModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="updateQuestModalLabel">Update Quest</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
    ...
    <script>
        $('a#updateQuesthref').on('click', function(event) {
            ...
            var actionUrl = "{{ route('internal_tutor.class.updateQuest', ['slug' => ':slug', 'id' => ':id']) }}"
                .replace(':slug', slug)
                .replace(':id', questId);
            // Set the form action
            $('#questUpdateForm').attr('action', actionUrl);
