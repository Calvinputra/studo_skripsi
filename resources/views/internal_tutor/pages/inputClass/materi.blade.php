                        ...
                        <div class="d-flex" style="justify-content: space-between;align-items: center;">
                            <div>
                                <p class="button-text-category">
                                    {{ $count_video }} Video, {{ $count_reading }} Reading <svg data-toggle="tooltip" title="Hooray!" title="Tooltip on top" width="21" height="20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path 
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" style="height:20px;" data-bs-toggle="modal" data-bs-target="#addChapterModal">
                                                <svg style="cursor:pointer;margin-top:-3px;" width="30" height="30" viewBox="0 0 30 30"
