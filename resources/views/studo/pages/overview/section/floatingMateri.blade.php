<div class="sidebar" style="margin-top:40px;">
    ...
    <!-- materi -->
    <div class="d-flex align-items-center justify-content-between" style="padding: 10px 16px;border: 1px solid #FFC100;border-radius: 0px 0px 0px 0px;background: #FFC100;">
        <div class="d-flex align-items-center">
