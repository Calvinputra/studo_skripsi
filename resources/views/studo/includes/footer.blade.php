    ...
    <div class="container d-flex align-items-center justify-content-between">
        <div>
            <p class="m-0" style="color:white">
                Copyright © 2023 [Nama Aplikasi]. All Rights Reserved.
            </p>
        </div>
        <div>
