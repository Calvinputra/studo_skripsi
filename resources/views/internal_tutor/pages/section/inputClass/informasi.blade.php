<script>
        tinymce.init({
            ...
            plugins: 'anchor autolink codesample emoticons image link lists searchreplace table visualblocks wordcount textcolor preview',
            toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough forecolor backcolor | link image preview table codesample | align lineheight | numlist bullist indent outdent | emoticons | removeformat',
            ...
            /*
              URL of our upload handler (for more details getChoosenChapterClass: https://www.tiny.cloud/docs/configure/file-image-upload/#images_upload_url)
