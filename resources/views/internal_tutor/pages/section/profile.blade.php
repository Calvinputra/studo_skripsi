<div class="row tab-pane fade show active" id="profile" role="tabpanel">
    ...
    <form method="post"action="{{ route('internal_tutor.post.profile.update_photo', auth()->user()->id) }}"
