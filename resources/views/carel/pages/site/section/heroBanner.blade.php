<div class="container" style="padding-top:40px;padding-bottom:80px;">
    <div class="row">
        ...
        <div class="col-sm-6" style="display:grid; align-items:center;">
            ...
            <a  href="{{route('carel.pages.overview.index')}}">
