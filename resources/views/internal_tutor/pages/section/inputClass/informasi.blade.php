...
<form action="{{ route('internal_tutor.class.store') }}" method="POST"  enctype="multipart/form-data" id="form-image">
    @csrf   
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="file" id="thumbnail" name="thumbnail" style="border: 1px solid black;border-radius:5px;" required="required">
                </div>
                <div class="form-group">
